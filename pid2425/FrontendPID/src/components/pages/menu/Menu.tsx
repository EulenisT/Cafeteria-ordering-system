...
export default function Menu() {
  ...
  const handleAddClick = (sandwich: SandwichesResponse) => {
    const sandwichName = sandwich.nom;
    const sandwichPrice = sandwich.prix;
    dispatch(addSandwich({ sandwichName, sandwichPrice }));
  };
      ...
      {data?.map((sandwich: SandwichesResponse) => (
        ...
        >
          <Card sx={{ maxWidth: 345 }}>
            ...
            {/* IconButton para agregar al "carrito" o lista */}
            <IconButton
